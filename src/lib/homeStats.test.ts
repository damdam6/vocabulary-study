...
describe("computeHomeStats", () => {
  ...
  it("복습 대기/학습 중/복습 예약이 섞인 목록의 카운트를 올바르게 집계한다", () => {
    const words: WordProgress[] = [
      ...
      { m1: 0, m2: 3, nextReview: null }, // learning (m1<3), m2 후보 없음
      { m1: 3, m2: 0, nextReview: null }, // learning (m2<3), m1 후보 없음
      { m1: 0, m2: 0, nextReview: null }, // learning, m1·m2 둘 다 후보
    ];
    ...
    // learningCandidates: 1 + 1 + 2 = 4, sessionCount = min(60, min(2,60) + 4)
